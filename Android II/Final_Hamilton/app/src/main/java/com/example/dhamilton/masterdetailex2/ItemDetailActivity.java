...
//Descritption: creates an activity to disply once an item is selected and display the detail tied to
//that specific item
...
public class ItemDetailActivity extends AppCompatActivity
{
    ...
    //Description: creates the item detail activity
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (savedInstanceState == null)
        {
            ...
            //Final Revision
            //Get String Details from intent and put it in Fragment Arguments
            ...
            //Sets the arguments in the fragment
